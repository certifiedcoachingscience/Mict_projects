export default class Bt {
    constructor(querySelectorString){
        ...
        this.root.innerHTML = index.html();
    ...
    static entryHTML(){
        ...
        <tr>
            ...
            <td>
                <input class="input input-description" type="text" placeholder="Add a description(eg. wages.bills.etc.)"/>
            </td>
            <td>
   ...
   save(){
    const data = this.getEntryRows().map(row =>{
        return{
            ...
            amount:parseFloat(querySelector(".input-amount").value),
   ...
   addEntry(entry = {}){
    this.root.querySelector(".entries").insertAdjacentHTML("beforeend", Bt.entryHTML());
    ...
    row.querySelector(".delete-amount").value = entry.amount || 0;
    row.querySelector(".delete-entry").addEventListner("click", e =>{
